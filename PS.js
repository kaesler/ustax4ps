...
(function($PS) {
  ...
  var showFilingStatus = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at CommonTypes (line 42, column 1 - line 44, column 25): " + [ v.constructor.name ]);
      }
  };                              
  ...
  exports["eqFilingStatus"] = eqFilingStatus;
...
(function($PS) {
  ...
  var ordinaryRateSuccessor = function (brackets) {
      return function (rate) {
  ...
  var unsafeOrdinaryRateSuccessor = function (brackets) {
      return function (rate) {
          var v = Data_Maybe.fromJust()(ordinaryRateSuccessor(brackets)(rate));
          return v;
      };
  };
...
(function($PS) {
  ...
  var showStandardDeduction = {
      show: function (v) {
          return Data_Show.show(Data_Show.showInt)(v);
      }
  };
  var showBracketStart = Data_Show.showInt;
                  ...
                  return function (personalExemptions) {
                      return function (socSec) {
                          return function (ordinaryIncome) {
                              return function (qualifiedIncome) {
                                  return function (itemized) {
                                      var boundRegime = Federal_BoundRegime.bindRegime(regime)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumYear)(year))(filingStatus)(birthDate)(personalExemptions);
                  ...
                  return function (personalExemptions) {
                      return function (socSec) {
                          return function (ordinaryIncome) {
                              return function (qualifiedIncome) {
                                  return function (itemized) {
                                      var v = taxResults(regime)(year)(filingStatus)(birthDate)(personalExemptions)(socSec)(ordinaryIncome)(qualifiedIncome)(itemized);
...
(function($PS) {
  ...
  var taxRate = function (year) {
      ...
      throw new Error("Failed pattern match at StateMA.Calculator (line 14, column 1 - line 14, column 26): " + [ year.constructor.name ]);
  };
              ...
              return function (filingStatus) {
                  return function (maGrossIncome) {
                      var personalExemption = (function () {
                          var $1 = Data_Eq.eq(CommonTypes.eqFilingStatus)(filingStatus)(CommonTypes.HeadOfHousehold.value);
                          if ($1) {
                              return 6800.0;
                          };
                          return 4400.0;
                      ...
                      var ageExemption = (function () {
                          var $2 = Age.isAge65OrOlder(bd)(year);
                          if ($2) {
                              return 700.0;
                          };
                          return 0.0;
...
(function($PS) {
  ...
  var UnsafeDates = $PS["UnsafeDates"];                
  var theYear2040 = UnsafeDates.unsafeMakeYear(2040);
  var theYear2030 = UnsafeDates.unsafeMakeYear(2030);
  var theYear = UnsafeDates.unsafeMakeYear(2021);
  var theRegime = Federal_Regime.Trump.value;
  var theBirthDate = UnsafeDates.unsafeMakeDate(2021)(10)(2);
  var print = function (dictShow) {
      return function (x) {
          return Effect_Console.log(Data_Show.show(dictShow)(x));
      };
  };
  var bracketsFor = function (fs) {
      var v = Federal_BoundRegime.bindRegime(theRegime)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumYear)(theYear))(fs)(theBirthDate)((function () {
          var $3 = Data_Eq.eq(CommonTypes.eqFilingStatus)(fs)(CommonTypes.Single.value);
          if ($3) {
              return 1;
          };
          return 2;
      })());
      return v.ordinaryIncomeBrackets;
  };
  var headOfHouseholdBrackets = bracketsFor(CommonTypes.HeadOfHousehold.value);
  var singleBrackets = bracketsFor(CommonTypes.Single.value);
  var main = function __do() {
      print(Data_Show.showNumber)(Federal_OrdinaryIncome.applyOrdinaryIncomeBrackets(headOfHouseholdBrackets)(50000.0))();
      print(Data_Show.showNumber)(Federal_Calculator.taxDue(theRegime)(theYear2030)(CommonTypes.Single.value)(theBirthDate)(1)(40000.0)(40000.0)(5000.0)(0.0))();
      print(Data_Show.showNumber)(StateMA_Calculator.taxDue(theYear2030)(theBirthDate)(1)(CommonTypes.Single.value)(50000.0))();
      print(Federal_Types.showBracketStart)(Federal_OrdinaryIncome.ordinaryIncomeBracketStart(singleBrackets)(22.0))();
      print(Data_Show.showInt)(Federal_OrdinaryIncome.ordinaryIncomeBracketWidth(singleBrackets)(22.0))();
      print(Data_Maybe.showMaybe(Federal_OrdinaryIncome.showOrdinaryRate))(Federal_OrdinaryIncome.ordinaryRateSuccessor(headOfHouseholdBrackets)(22.0))();
      print(Data_Maybe.showMaybe(Data_Show.showNumber))(Federal_RMDs.rmdFractionForAge(76))();
      (function () {
          var v = Federal_BoundRegime.bindRegime(theRegime)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumYear)(theYear))(CommonTypes.Single.value)(theBirthDate)(1);
          return print(Data_Show.showInt)(Federal_QualifiedIncome.startOfNonZeroQualifiedRateBracket(v.qualifiedIncomeBrackets))();
      })();
      (function () {
          var br = Federal_BoundRegime.bindRegime(theRegime)(Data_Enum.fromEnum(Data_Date_Component.boundedEnumYear)(theYear))(CommonTypes.Single.value)(theBirthDate)(1);
          return print(Federal_Types.showStandardDeduction)(Federal_BoundRegime.standardDeduction(br))();
      })();
      print(Data_Show.showNumber)(Federal_TaxableSocialSecurity.amountTaxable(CommonTypes.HeadOfHousehold.value)(40000.0)(40000.0))();
      print(Data_Show.showNumber)(Federal_TaxableSocialSecurity.amountTaxableInflationAdjusted(theYear2040)(CommonTypes.Single.value)(50000.0)(40000.0))();
      print(Federal_OrdinaryIncome.showOrdinaryRate)(22.0)();
      print(Data_Show.showNumber)(Federal_OrdinaryIncome.unsafeOrdinaryRateSuccessor(singleBrackets)(22.0))();
      print(CommonTypes.showFilingStatus)(CommonTypes.unsafeReadFilingStatus("Single"))();
      print(Data_Show.showNumber)(Federal_RMDs.unsafeRmdFractionForAge(76))();
      return print(Data_Show.showNumber)(StateMA_Calculator.taxRate(theYear))();
  };
  exports["print"] = print;
  exports["theYear2030"] = theYear2030;
  exports["theYear2040"] = theYear2040;
  exports["theYear"] = theYear;
  exports["theRegime"] = theRegime;
  exports["theBirthDate"] = theBirthDate;
  exports["bracketsFor"] = bracketsFor;
  exports["singleBrackets"] = singleBrackets;
  exports["headOfHouseholdBrackets"] = headOfHouseholdBrackets;
  exports["main"] = main;
})(PS);
PS["Main"].main();