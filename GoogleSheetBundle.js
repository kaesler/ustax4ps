...
(function($PS) {
  ...
  var showRegime = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Federal.Regime (line 23, column 1 - line 25, column 29): " + [ v.constructor.name ]);
      }
  };
  var readRegime = {
      read: function (s) {
...
(function($PS) {
  ...
  var perPersonExemptionFor = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Federal.BoundRegime (line 91, column 1 - line 91, column 53): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
