...
(function($PS) {
          ...
          return function (relevantIncome) {
              var f = function (combinedIncome) {
                  return function (v) {
                      ...
                      throw new Error("Failed pattern match at Taxes (line 419, column 3 - line 419, column 71): " + [ combinedIncome.constructor.name, v.constructor.name ]);
                  };
              };
              var lowBase = (function () {
                  ...
                  throw new Error("Failed pattern match at Taxes (line 407, column 15 - line 409, column 33): " + [ filingStatus.constructor.name ]);
              })();
              var highBase = (function () {
                  ...
                  throw new Error("Failed pattern match at Taxes (line 411, column 16 - line 413, column 33): " + [ filingStatus.constructor.name ]);
              })();
  ...
  var standardDeduction = function (v) {
      ...
      throw new Error("Failed pattern match at Taxes (line 361, column 1 - line 361, column 55): " + [ v.constructor.name ]);
  };
  ...
  var qualifiedBracketStarts = function (v) {
      ...
      throw new Error("Failed pattern match at Taxes (line 288, column 1 - line 288, column 73): " + [ v.constructor.name ]);
  };
  ...
  var ordinaryIncomeBracketStarts = function (v) {
      ...
      throw new Error("Failed pattern match at Taxes (line 196, column 1 - line 196, column 77): " + [ v.constructor.name ]);
  };
          ...
          return function (filingStatus) {
              return function (maGrossIncome) {
                  var personalExemption = (function () {
                      var $119 = Data_Eq.eq(eqFilingStatus)(filingStatus)(HeadOfHousehold.value);
                      if ($119) {
                          return 6800.0;
                      };
                      return 4400.0;
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      return print(Data_Show.showNumber)(Taxes.taxableSocialSecurityAdjusted(2040)(Taxes.Single.value)(50000.0)(40000.0))();
  };
  exports["print"] = print;
  exports["main"] = main;
})(PS);
